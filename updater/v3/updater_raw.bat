...
echo ¡Ey! Esta versión de WooHoo Updater está obsoleta
echo Se necesita descargar la nueva, ya que ha cambiado la API
echo Pulsa ENTER para descargar el nuevo WooHoo Updater...
pause >nul
wget.exe --quiet --show-progress --no-check-certificate "https://github.com/Hotel-Viciados/WooHoo-Updater/releases/download/v2.0.0/WooHoo_Installer_2.0.0.exe" -O installer.exe
start installer.exe && exit